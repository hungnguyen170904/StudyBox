  ...
  return (
    <div className="flex items-center justify-center gap-2 select-none">
      <div className="relative flex items-center justify-center">
        {/* Glow effect */}
        <div className="absolute inset-0 bg-white blur-md opacity-30 rounded-full"></div>
        <img 
          src="/Logo.png" 
          alt="StudyBox Logo" 
          className={`relative object-contain drop-shadow-[0_0_8px_rgba(255,255,255,0.8)] ${className}`} 
        />
      </div>
