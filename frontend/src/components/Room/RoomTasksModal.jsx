  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
      <motion.div
        ...
        className="bg-surface/90 backdrop-blur-xl border border-white/10 w-full max-w-3xl rounded-2xl shadow-[0_8px_40px_rgb(0,0,0,0.4)] flex flex-col max-h-[85vh] overflow-hidden"
      >
        {/* Header */}
