...
import { Mail, Lock, ArrowRight, BookOpen, Users, Zap } from 'lucide-react';
    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden items-center justify-center p-12"
        ...
        <div className="relative z-10 max-w-sm">
          ...
          <p className="text-white/50 mb-10 text-sm leading-relaxed">
            Nền tảng học nhóm trực tuyến với đầy đủ công cụ cộng tác hiện đại.
          </p>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-sm">
          ...
          <p className="text-white/40 text-sm mb-8">Đăng nhập để kết nối và học tập cùng bạn bè.</p>
