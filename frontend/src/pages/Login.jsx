    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-4">
      ...
      <div className="w-full max-w-md glass-panel p-8 rounded-2xl relative overflow-hidden">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-white/70 mt-2 text-sm">Đăng nhập để kết nối và học tập</p>
        </div>
        ...
        <p className="mt-8 text-center text-sm text-white/70">
          Chưa có tài khoản?{' '}
          <Link to="/register" className="text-white font-bold hover:underline transition-colors drop-shadow-md">
            Đăng ký ngay
          </Link>
        </p>
      </div>
